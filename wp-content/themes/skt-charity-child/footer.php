...
<div id="footer-wrapper">
        ...
        <div class="container">
            	<div class="copyright-txt"><?php esc_attr_e('&copy; ' . date('Y'),'skt-charity');?> <?php bloginfo('name'); ?>. <?php esc_attr_e('All Rights Reserved', 'skt-charity');?></div>
                <div class="design-by"><?php printf('Design By: <a href="http://www.thirdeyesystem.com/" rel="nofollow" target="_blank">Third Eye System</a>' ); ?></div>
            </div>
            <div class="clear"></div>
        </div>
    </div>
